...
最近はすぐレートリミットに到達してしまうので、Geminiのドキュメントを読んだりしていたのだけど、
開発に影響が出ない150RPM以上のレートでGeminiを使えるようにするにはTier1(いわゆる通常の課金)を行う必要があるらしい。
一応Tier1なのだけど、どうしてすぐレートに引っかかるのだろうか...
